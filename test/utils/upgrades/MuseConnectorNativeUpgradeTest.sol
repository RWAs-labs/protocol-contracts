...
/// @title MuseConnectorNativeUpgradeTest
/// @notice Modified MuseConnectorNative.sol contract for testing upgrades
/// @dev The only difference is in event naming
/// @custom:oz-upgrades-from MuseConnectorNative.sol
contract MuseConnectorNativeUpgradeTest is MuseConnectorBase {
