...
export interface MuseConnectorNonNativeUpgradeTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
  ...
  getEvent(
    nameOrSignatureOrTopic:
      ...
      | "RoleRevoked"
      | "Unpaused"
      | "UpdatedMuseConnectorTSSAddress"
      | "Upgraded"
      | "Withdrawn"
      | "WithdrawnAndCalled"
...
export namespace UpdatedMuseConnectorTSSAddressEvent {
  export type InputTuple = [
...
export interface MuseConnectorNonNativeUpgradeTest extends BaseContract {
  connect(runner?: ContractRunner | null): MuseConnectorNonNativeUpgradeTest;
  waitForDeployment(): Promise<this>;

  interface: MuseConnectorNonNativeUpgradeTestInterface;
  ...
  >;
  getEvent(
    key: "UpdatedMuseConnectorTSSAddress"
  ): TypedContractEvent<
    UpdatedMuseConnectorTSSAddressEvent.InputTuple,
    UpdatedMuseConnectorTSSAddressEvent.OutputTuple,
    UpdatedMuseConnectorTSSAddressEvent.OutputObject
  >;
  getEvent(
    key: "Upgraded"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "UpdatedMuseConnectorTSSAddress(address,address)": TypedContractEvent<
      UpdatedMuseConnectorTSSAddressEvent.InputTuple,
      UpdatedMuseConnectorTSSAddressEvent.OutputTuple,
      UpdatedMuseConnectorTSSAddressEvent.OutputObject
    >;
    UpdatedMuseConnectorTSSAddress: TypedContractEvent<
      UpdatedMuseConnectorTSSAddressEvent.InputTuple,
      UpdatedMuseConnectorTSSAddressEvent.OutputTuple,
      UpdatedMuseConnectorTSSAddressEvent.OutputObject
    >;
