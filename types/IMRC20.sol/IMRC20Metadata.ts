...
export interface IMRC20MetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GAS_LIMIT"
      | "PROTOCOL_FLAT_FEE"
...
export interface IMRC20Metadata extends BaseContract {
  connect(runner?: ContractRunner | null): IMRC20Metadata;
  waitForDeployment(): Promise<this>;

  interface: IMRC20MetadataInterface;
