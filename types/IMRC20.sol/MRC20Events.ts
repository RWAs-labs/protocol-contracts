...
export interface MRC20EventsInterface extends Interface {
  getEvent(
...
export interface MRC20Events extends BaseContract {
  connect(runner?: ContractRunner | null): MRC20Events;
  waitForDeployment(): Promise<this>;

  interface: MRC20EventsInterface;
