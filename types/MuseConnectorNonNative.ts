...
export interface MuseConnectorNonNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface MuseConnectorNonNative extends BaseContract {
  connect(runner?: ContractRunner | null): MuseConnectorNonNative;
  waitForDeployment(): Promise<this>;

  interface: MuseConnectorNonNativeInterface;
