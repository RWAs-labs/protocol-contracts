...
export interface MuseNonEthInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MuseNonEth extends BaseContract {
  connect(runner?: ContractRunner | null): MuseNonEth;
  waitForDeployment(): Promise<this>;

  interface: MuseNonEthInterface;
