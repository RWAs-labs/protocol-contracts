...
export interface IMuseConnectorEventsInterface extends Interface {
  getEvent(
...
export interface IMuseConnectorEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IMuseConnectorEvents;
  waitForDeployment(): Promise<this>;

  interface: IMuseConnectorEventsInterface;
