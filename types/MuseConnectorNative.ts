...
export interface MuseConnectorNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface MuseConnectorNative extends BaseContract {
  connect(runner?: ContractRunner | null): MuseConnectorNative;
  waitForDeployment(): Promise<this>;

  interface: MuseConnectorNativeInterface;
