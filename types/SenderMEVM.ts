...
export interface SenderMEVMInterface extends Interface {
  getFunction(
...
export interface SenderMEVM extends BaseContract {
  connect(runner?: ContractRunner | null): SenderMEVM;
  waitForDeployment(): Promise<this>;

  interface: SenderMEVMInterface;
