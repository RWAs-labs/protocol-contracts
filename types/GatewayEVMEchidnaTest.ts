...
export interface GatewayEVMEchidnaTest extends BaseContract {
  ...
  initialize: TypedContractMethod<
    [tssAddress_: AddressLike, museToken_: AddressLike, admin_: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[museConnector_: AddressLike], [void], "nonpayable">;
  getFunction(
