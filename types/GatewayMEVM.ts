...
export interface GatewayMEVMInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_MESSAGE_SIZE"
...
export interface GatewayMEVM extends BaseContract {
  connect(runner?: ContractRunner | null): GatewayMEVM;
  waitForDeployment(): Promise<this>;

  interface: GatewayMEVMInterface;
