...
export interface GatewayMEVMUpgradeTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_MESSAGE_SIZE"
...
export interface GatewayMEVMUpgradeTest extends BaseContract {
  connect(runner?: ContractRunner | null): GatewayMEVMUpgradeTest;
  waitForDeployment(): Promise<this>;

  interface: GatewayMEVMUpgradeTestInterface;
  ...
  deposit: TypedContractMethod<
    [mrc20: AddressLike, amount: BigNumberish, target: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [museToken_: AddressLike, admin_: AddressLike],
    [void],
    "nonpayable"
  >;
