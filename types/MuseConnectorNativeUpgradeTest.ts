...
export interface MuseConnectorNativeUpgradeTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "PAUSER_ROLE"
...
export interface MuseConnectorNativeUpgradeTest extends BaseContract {
  connect(runner?: ContractRunner | null): MuseConnectorNativeUpgradeTest;
  waitForDeployment(): Promise<this>;

  interface: MuseConnectorNativeUpgradeTestInterface;
