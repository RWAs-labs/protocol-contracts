...
import type {
  IGatewayMEVM,
  IGatewayMEVMInterface,
} from "../../IGatewayMEVM.sol/IGatewayMEVM";
...
export class IGatewayMEVM__factory {
  static readonly abi = _abi;
  static createInterface(): IGatewayMEVMInterface {
    return new Interface(_abi) as IGatewayMEVMInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IGatewayMEVM {
    return new Contract(address, _abi, runner) as unknown as IGatewayMEVM;
  }
}
