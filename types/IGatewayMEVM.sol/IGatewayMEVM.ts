...
export interface IGatewayMEVMInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "call"
      | "deposit"
...
export interface IGatewayMEVM extends BaseContract {
  connect(runner?: ContractRunner | null): IGatewayMEVM;
  waitForDeployment(): Promise<this>;

  interface: IGatewayMEVMInterface;
