...
export interface IGatewayMEVMEventsInterface extends Interface {
  getEvent(
...
export interface IGatewayMEVMEvents extends BaseContract {
  connect(runner?: ContractRunner | null): IGatewayMEVMEvents;
  waitForDeployment(): Promise<this>;

  interface: IGatewayMEVMEventsInterface;
