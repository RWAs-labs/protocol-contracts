...
func (_UniversalContract *UniversalContractTransactor) OnCall(opts *bind.TransactOpts, context MessageContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _UniversalContract.contract.Transact(opts, "onCall", context, mrc20, amount, message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_UniversalContract *UniversalContractSession) OnCall(context MessageContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _UniversalContract.Contract.OnCall(&_UniversalContract.TransactOpts, context, mrc20, amount, message)
}

// OnCall is a paid mutator transaction binding the contract method 0x5bcfd616.
//
// Solidity: function onCall((bytes,address,uint256) context, address mrc20, uint256 amount, bytes message) returns()
func (_UniversalContract *UniversalContractTransactorSession) OnCall(context MessageContext, mrc20 common.Address, amount *big.Int, message []byte) (*types.Transaction, error) {
	return _UniversalContract.Contract.OnCall(&_UniversalContract.TransactOpts, context, mrc20, amount, message)
}
