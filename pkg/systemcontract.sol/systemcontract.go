...
func DeploySystemContract(auth *bind.TransactOpts, backend bind.ContractBackend, wmuse_ common.Address, uniswapv2Factory_ common.Address, uniswapv2Router02_ common.Address) (common.Address, *types.Transaction, *SystemContract, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(SystemContractBin), backend, wmuse_, uniswapv2Factory_, uniswapv2Router02_)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_SystemContract *SystemContractCaller) GasCoinMRC20ByChainId(opts *bind.CallOpts, arg0 *big.Int) (common.Address, error) {
	var out []interface{}
	err := _SystemContract.contract.Call(opts, &out, "gasCoinMRC20ByChainId", arg0)
...
func (_SystemContract *SystemContractCaller) WMuseContractAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SystemContract.contract.Call(opts, &out, "wMuseContractAddress")
...
func (_SystemContract *SystemContractTransactor) DepositAndCall(opts *bind.TransactOpts, context MContext, mrc20 common.Address, amount *big.Int, target common.Address, message []byte) (*types.Transaction, error) {
	return _SystemContract.contract.Transact(opts, "depositAndCall", context, mrc20, amount, target, message)
}

// DepositAndCall is a paid mutator transaction binding the contract method 0xc39aca37.
//
// Solidity: function depositAndCall((bytes,address,uint256) context, address mrc20, uint256 amount, address target, bytes message) returns()
func (_SystemContract *SystemContractSession) DepositAndCall(context MContext, mrc20 common.Address, amount *big.Int, target common.Address, message []byte) (*types.Transaction, error) {
...
//
// Solidity: function depositAndCall((bytes,address,uint256) context, address mrc20, uint256 amount, address target, bytes message) returns()
func (_SystemContract *SystemContractTransactorSession) DepositAndCall(context MContext, mrc20 common.Address, amount *big.Int, target common.Address, message []byte) (*types.Transaction, error) {
	return _SystemContract.Contract.DepositAndCall(&_SystemContract.TransactOpts, context, mrc20, amount, target, message)
}
...
// SystemContractSetConnectorMEVMIterator is returned from FilterSetConnectorMEVM and is used to iterate over the raw logs and unpacked data for SetConnectorMEVM events raised by the SystemContract contract.
type SystemContractSetConnectorMEVMIterator struct {
	Event *SystemContractSetConnectorMEVM // Event containing the contract specifics and raw log
...
func (it *SystemContractSetConnectorMEVMIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SystemContractSetConnectorMEVM)
...
func (it *SystemContractSetConnectorMEVMIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SystemContractSetConnectorMEVMIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SystemContractSetConnectorMEVM represents a SetConnectorMEVM event raised by the SystemContract contract.
type SystemContractSetConnectorMEVM struct {
	Arg0 common.Address
...
func (_SystemContract *SystemContractFilterer) FilterSetConnectorMEVM(opts *bind.FilterOpts) (*SystemContractSetConnectorMEVMIterator, error) {
	...
	logs, sub, err := _SystemContract.contract.FilterLogs(opts, "SetConnectorMEVM")
	if err != nil {
		return nil, err
	}
...
func (_SystemContract *SystemContractFilterer) WatchSetConnectorMEVM(opts *bind.WatchOpts, sink chan<- *SystemContractSetConnectorMEVM) (event.Subscription, error) {
	...
	logs, sub, err := _SystemContract.contract.WatchLogs(opts, "SetConnectorMEVM")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(SystemContractSetConnectorMEVM)
				if err := _SystemContract.contract.UnpackLog(event, "SetConnectorMEVM", log); err != nil {
					return err
				}
				event.Raw = log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SystemContractSetWMuseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SystemContractSetWMuse)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SystemContractSetWMuseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SystemContractSetWMuseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SystemContractSetWMuse represents a SetWMuse event raised by the SystemContract contract.
type SystemContractSetWMuse struct {
	Arg0 common.Address
	Raw  types.Log // Blockchain specific contextual infos
}
...
func (_SystemContract *SystemContractFilterer) FilterSetWMuse(opts *bind.FilterOpts) (*SystemContractSetWMuseIterator, error) {
	...
	logs, sub, err := _SystemContract.contract.FilterLogs(opts, "SetWMuse")
	if err != nil {
		return nil, err
	}
...
func (_SystemContract *SystemContractFilterer) WatchSetWMuse(opts *bind.WatchOpts, sink chan<- *SystemContractSetWMuse) (event.Subscription, error) {
	...
	logs, sub, err := _SystemContract.contract.WatchLogs(opts, "SetWMuse")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SystemContractSetWMuse)
				if err := _SystemContract.contract.UnpackLog(event, "SetWMuse", log); err != nil {
					return err
				}
				event.Raw = log
