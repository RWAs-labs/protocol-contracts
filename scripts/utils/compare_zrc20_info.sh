...
# This script compares the attributes of two MRC20.sol contracts on a blockchain.
# It takes two contract addresses and an RPC URL, fetches their values, and compares them.
#
# Usage:
#   ./compare_mrc20_info.sh <contract_address_1> <contract_address_2> <rpc_url>
...
# Function to fetch MRC20.sol attributes
fetch_mrc20_info() {
    ...
    echo "$SYSTEM_CONTRACT,$MRC20_NAME,$MRC20_SYMBOL,$MRC20_DECIMALS,$MRC20_CHAIN_ID,$MRC20_COIN_TYPE,$MRC20_GAS_LIMIT"
}

# Fetch attributes for both contracts
INFO_1=$(fetch_mrc20_info $CONTRACT_ADDRESS_1 $RPC_URL)
INFO_2=$(fetch_mrc20_info $CONTRACT_ADDRESS_2 $RPC_URL)
...
ATTRIBUTES=("SYSTEM_CONTRACT" "MRC20_NAME" "MRC20_SYMBOL" "MRC20_DECIMALS" "MRC20_CHAIN_ID" "MRC20_COIN_TYPE" "MRC20_GAS_LIMIT")
