...
/// @notice Provides contextual information when executing a cross-chain call on MuseChain.
...
/// @notice Interface for contracts that can receive cross-chain calls on MuseChain.
...
interface UniversalContract {
    function onCall(MessageContext calldata context, address mrc20, uint256 amount, bytes calldata message) external;
}
