...
/// @param onRevertGasLimit Gas limit for revert tx, unused on GatewayMEVM.sol methods
...
/// token address or is empty if it's a gas token. On MuseChain, it contains the
/// address of the MRC20.sol.
...
/// address of the MRC20.sol.
/// @param amount Amount specified with the transaction.
/// @param outgoing Flag to indicate if the crosschain transaction was outgoing: from MuseChain to connected chain.
/// if false, the transaction was incoming: from connected chain to MuseChain.
