...
import "./interfaces/IMuseNonEthNew.sol";

/// @title MuseConnectorNonNative.sol
/// @notice Implementation of MuseConnectorBase.sol for non-native token handling.
/// @dev This contract mints and burns Muse tokens and interacts with the Gateway contract.
contract MuseConnectorNonNative is MuseConnectorBase {
