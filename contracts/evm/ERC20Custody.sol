...
/// @title ERC20Custody
/// @notice Holds the ERC20 tokens deposited on MuseChain and includes functionality to call a contract.
    ...
    PausableUpgradeable
{
    ...
    /// @notice Deposits asset to custody and pay fee in muse erc20.
